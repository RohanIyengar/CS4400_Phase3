...
public class SQLTableCreator {
    ...
    public static void main(String args[]) {
        ...
        creator.createProjectTable();
        creator.deleteProjectTable();
        creator.createProjectRequirementTable();
        creator.deleteProjectRequirementTable();
        creator.createDesignationTable();
        creator.deleteDesignationTable();
        creator.createCategoryTable();
        creator.deleteCategoryTable();
        creator.createMajorTable();
        creator.deleteMajorTable();
        creator.createDepartmentTable();
        creator.deleteDepartmentTable();
        creator.createCourseTable();
        creator.deleteCourseTable();
        creator.createApplyTable();
        creator.deleteApplyTable();
        creator.createProjectIsCategoryTable();
        creator.deleteProjectIsCategoryTable();
        creator.createCourseIsCategoryTable();
        creator.deleteCourseIsCategoryTable();
    }
}
